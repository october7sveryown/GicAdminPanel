...
<html>
<head>
    <link rel="shortcut icon" href="images/ic_r.png" type="image/png"/>
...
<!----->
        <nav class="navbar-default navbar-static-top" role="navigation">
             <div class="navbar-header">
               ...
               <h1> <a class="navbar-brand" href="index.php">Resourcify</a></h1>         
			   </div>
...
-->					 <li>
                        <a href="add.php" class=" hvr-bounce-to-right"><i class="fa fa-plus nav_icon"></i><span class="nav-label">Add user</span> </a>
                    </li>
                    
                    <li>
                        <a href="remove.php" class=" hvr-bounce-to-right"><i class="fa fa-remove nav_icon"></i><span class="nav-label">Remove user</span> </a>
                    </li>
                     <li>
                    ...
                    --> <li>
                        <a href="edit.php" class=" hvr-bounce-to-right"><i class="fa fa-edit nav_icon"></i><span class="nav-label">Edit user</span> </a>
                    </li>
            ...
            <!--        <li>
               ...
               -->     <li>
                        <a href="#" class=" hvr-bounce-to-right"><i class="fa fa-search-plus nav_icon"></i><span class="nav-label">Search</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="search.php" class=" hvr-bounce-to-right"><i class="fa fa-user nav_icon"></i>Search by username</a></li>
                            <li><a href="search1.php" class=" hvr-bounce-to-right"><i class="fa fa-users nav_icon"></i>All users</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
...
<div id="page-wrapper" class="gray-bg dashbard-1">
 	...
 	<!--banner-->	
		     <div class="banner">
				...
				<span>Search</span><i class="fa fa-angle-right"></i><span>Search by username</span>
				</h2>
		    </div>
		
<div class="grid-form">
 		<div class="grid-form1">
 		<h3 id="forms-example" class="">Search by Username</h3>
 		<form action="">
...
$sql = "SELECT username,email,password FROM users WHERE username='$uname'"; 
